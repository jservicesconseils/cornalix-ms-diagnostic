 ...
 * User Pool que cornalix-ms-identity (voir SCRUM-1/SCRUM-2) : une seule
 * source d'identite pour toute la plateforme, chaque microservice se
 * contente de verifier le jeton, jamais de gerer de compte lui-meme.
 *
 * Regles :
